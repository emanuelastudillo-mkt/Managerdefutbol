...
- En **Estadio**, debajo de Hinchada y entradas, se agrega el bloque **Hacer campañas para sumar socios**.
- Se agregan tres campañas configurables:
  - $50.000.000 · 60 días.
  - $500.000.000 · 90 días.
  - $100.000.000 · 10 días.
- La interfaz muestra sólo inversión y duración.
- Los socios diarios y el total captado quedan ocultos.
- Las campañas suman socios día a día mientras están activas.
- El costo se descuenta al iniciar la campaña y se registra en Finanzas como **Campaña de socios**.
...
- El rango 61-70 se agrega como puente para no dejar un hueco entre 60 y 71.
- Los rangos quedan centralizados en `balance-modificadores.js`, dentro de `simulador.recuperacionPostPartidoPorResistencia`.
- Si `recuperacionPostPartidoUsaResistencia` se desactiva, queda como respaldo el rango fijo anterior `recuperacionAutomaticaPostPartidoMin/Max`.
