...
window.GAME_CONFIG = {
  ...
  marca: {
    ...
    logoPath: 'assets/logo-banner.svg',
    logoAlt: 'Una vida de manager',
    urlPublica: 'https://unavidademanager.com/',
    imagenSocial: 'https://unavidademanager.com/assets/logo-banner.svg'
  },
  partidas: {
  ...
  data: {
    ...
    leagueUrls: ['data/Liga Argentina.json?v=8.54', 'data/Liga Chile.json', 'data/Liga Brasil.json', 'data/Liga Inglaterra.json', 'data/Liga Espana.json', 'data/Liga Italia.json', 'data/Liga Rumania.json'],
    ...
    manualPlayersUrl: 'data/jugadores_manuales.json?v=8.54',
    sponsorsUrl: 'data/sponsors.json',
    employeesUrl: 'data/empleados.json',
    installationsUrl: 'data/instalaciones.json?v=8.54',
    eventsUrl: 'data/eventos.json?v=8.54',
    specialSkillsUrl: 'data/habilidades_especiales.json?v=8.54',
    managerAchievementsUrl: 'data/hitos_manager.json?v=8.54',
