...
window.GAME_CONFIG = {
  ...
  data: {
    ...
    leagueUrls: ['data/Liga Argentina.json?v=8.80', 'data/Liga Chile.json?v=8.80', 'data/Liga Brasil.json?v=8.80', 'data/Liga Inglaterra.json?v=8.80', 'data/Liga Espana.json?v=8.80', 'data/Liga Italia.json?v=8.80', 'data/Liga Rumania.json?v=8.80'],
    // Manifest principal y chunks de jugadores. Si playersUrls está definido, el juego carga esos archivos en paralelo.
    playersUrl: 'data/jugadores.json?v=8.80',
    playersUrls: [
      'data/jugadores/argentina-liga-profesional.json?v=8.80',
      'data/jugadores/argentina-primera-nacional.json?v=8.80',
      'data/jugadores/argentina-federal-a.json?v=8.80',
      'data/jugadores/chile-primera-division-chile.json?v=8.80',
      'data/jugadores/brasil-brasileirao.json?v=8.80',
      'data/jugadores/inglaterra-premier-league.json?v=8.80',
      'data/jugadores/espana-laliga-espana.json?v=8.80',
      'data/jugadores/italia-serie-a-italia.json?v=8.80',
      'data/jugadores/rumania-superliga-rumania.json?v=8.80'
    ],
    manualPlayersUrl: 'data/jugadores_manuales.json?v=8.80',
    sponsorsUrl: 'data/sponsors.json?v=8.80',
    employeesUrl: 'data/empleados.json?v=8.80',
    installationsUrl: 'data/instalaciones.json?v=8.80',
    eventsUrl: 'data/eventos.json?v=8.80',
    specialSkillsUrl: 'data/habilidades_especiales.json?v=8.80',
    managerAchievementsUrl: 'data/hitos_manager.json?v=8.80',
    retosManagerUrl: 'data/retos_manager.json?v=8.80',
    estadiosUrls: ['data/estadios_argentina.json?v=8.80', 'data/estadios_chile.json?v=8.80', 'data/estadios_brasil.json?v=8.80', 'data/estadios_inglaterra.json?v=8.80', 'data/estadios_espana.json?v=8.80', 'data/estadios_italia.json?v=8.80', 'data/estadios_rumania.json?v=8.80'],
    hinchasUrls: ['data/hinchas_argentina.json?v=8.80', 'data/hinchas_chile.json?v=8.80', 'data/hinchas_brasil.json?v=8.80', 'data/hinchas_inglaterra.json?v=8.80', 'data/hinchas_espana.json?v=8.80', 'data/hinchas_italia.json?v=8.80', 'data/hinchas_rumania.json?v=8.80'],
    relatosPartidoUrl: 'data/relatos_partido.json?v=8.80'
  },
  calendario: {
    ...
    // Copas nacionales V8.80: sorteos días 20 a 25; rondas el primer miércoles de marzo, mayo, junio, agosto, septiembre y octubre.
