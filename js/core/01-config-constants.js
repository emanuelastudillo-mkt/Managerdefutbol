...
const SPECIAL_SKILLS_DATABASE_URL = configValue('data.specialSkillsUrl', 'data/habilidades_especiales.json?v=7.60');
...
const APP_VERSION = configValue('version', 'V7.60');
