...
const BOT_BALANCE_MATCH_WEAR_CAP = configNumber('equilibrioBots.desgasteMaximoBotAntesDePartido', 38, 0, PLAYER_WEAR_MAX);
...
const BOT_QUICK_OVEREXERTION_XG_EXTRA = configNumber('equilibrioBots.tacticaRapida.xgExtraSiPierde', 0.35, 0, 3);
const BOT_QUICK_OVEREXERTION_GOAL_CHANCE = configNumber('equilibrioBots.tacticaRapida.probabilidadGolExtraSiPierde', 0.34, 0, 1);
...
const BOT_QUICK_OVEREXERTION_EXTRA_WEAR = configNumber('equilibrioBots.tacticaRapida.desgasteExtraPorSobreexigencia', 2, 0, 10);
const BOT_QUICK_OVEREXERTION_CONDITION_DELTA = -Math.abs(configNumber('equilibrioBots.tacticaRapida.condicionExtraDelta', -2, -20, 20));
...
const SPONSOR_UPFRONT_PAYMENT_CHANCE = configNumber('sponsors.probabilidadPagoUnico', 0.50, 0, 1);
const SPONSOR_UPFRONT_DISCOUNT = configNumber('sponsors.descuentoPagoUnico', 0.50, 0, 1);
