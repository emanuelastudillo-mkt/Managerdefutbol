...
const INSTALLATIONS_DATABASE_URL = configValue('data.installationsUrl', 'data/instalaciones.json?v=7.61');
const EVENTS_DATABASE_URL = configValue('data.eventsUrl', 'data/eventos.json');
const SPECIAL_SKILLS_DATABASE_URL = configValue('data.specialSkillsUrl', 'data/habilidades_especiales.json?v=7.61');
...
const APP_VERSION = configValue('version', 'V7.61');
