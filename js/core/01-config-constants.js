...
const SPECIAL_SKILLS_DATABASE_URL = configValue('data.specialSkillsUrl', 'data/habilidades_especiales.json?v=7.51');
...
const APP_VERSION = configValue('version', 'V7.51');
