...
const LIBERTADORES_TEAM_POOL_CONFIG = Object.freeze({
  ...
  rosterVersion:'V9.50',
  teams:Object.freeze([
    { id:910004, name:'Olimpia', country:'Paraguay', city:'Asunción', reputation:71, primaryColor:'#FFFFFF', crestPath:'img/escudos/Olimpia.svg', nationalityPool:['Paraguay','Paraguay','Paraguay','Paraguay','Paraguay','Paraguay','Argentina','Uruguay','Brasil'] },
    { id:910003, name:'Cerro Porteño', country:'Paraguay', city:'Asunción', reputation:68, primaryColor:'#D71920', crestPath:'img/escudos/Cerro-Porteño.svg', nationalityPool:['Paraguay','Paraguay','Paraguay','Paraguay','Paraguay','Paraguay','Argentina','Uruguay','Colombia'] },
    { id:920001, name:'Universitario', country:'Perú', city:'Lima', reputation:63, primaryColor:'#F5E6C8', crestPath:'img/escudos/Universitario.svg', nationalityPool:['Perú','Perú','Perú','Perú','Perú','Perú','Argentina','Uruguay','Colombia'] },
    { id:920002, name:'Sporting Cristal', country:'Perú', city:'Lima', reputation:61, primaryColor:'#65C7F7', crestPath:'img/escudos/Sporting-Cristal.svg', nationalityPool:['Perú','Perú','Perú','Perú','Perú','Perú','Argentina','Uruguay','Colombia'] },
    { id:920003, name:'Atlético Nacional', country:'Colombia', city:'Medellín', reputation:68, primaryColor:'#138A36', crestPath:'img/escudos/Atletico-Nacional.svg', nationalityPool:['Colombia','Colombia','Colombia','Colombia','Colombia','Colombia','Argentina','Uruguay','Venezuela'] },
    { id:920004, name:'Junior', country:'Colombia', city:'Barranquilla', reputation:64, primaryColor:'#D71920', crestPath:'img/escudos/Junior.svg', nationalityPool:['Colombia','Colombia','Colombia','Colombia','Colombia','Colombia','Argentina','Uruguay','Venezuela'] },
    { id:920005, name:'Peñarol', country:'Uruguay', city:'Montevideo', reputation:75, primaryColor:'#F4D21F', crestPath:'img/escudos/Penarol.svg', nationalityPool:['Uruguay','Uruguay','Uruguay','Uruguay','Uruguay','Uruguay','Argentina','Paraguay','Brasil'] },
    { id:920006, name:'Nacional', country:'Uruguay', city:'Montevideo', reputation:74, primaryColor:'#153D8A', crestPath:'img/escudos/Nacional-Uruguay.svg', nationalityPool:['Uruguay','Uruguay','Uruguay','Uruguay','Uruguay','Uruguay','Argentina','Paraguay','Brasil'] },
    { id:920007, name:'Deportivo Táchira', country:'Venezuela', city:'San Cristóbal', reputation:56, primaryColor:'#F2D21B', crestPath:'img/escudos/Deportivo-Tachira.svg', nationalityPool:['Venezuela','Venezuela','Venezuela','Venezuela','Venezuela','Venezuela','Colombia','Argentina','Uruguay'] },
    { id:920008, name:'Caracas FC', country:'Venezuela', city:'Caracas', reputation:54, primaryColor:'#C8102E', crestPath:'img/escudos/Caracas-FC.svg', nationalityPool:['Venezuela','Venezuela','Venezuela','Venezuela','Venezuela','Venezuela','Colombia','Argentina','Uruguay'] },
    { id:920009, name:'LDU Quito', country:'Ecuador', city:'Quito', reputation:73, primaryColor:'#FFFFFF', crestPath:'img/escudos/LDU-Quito.svg', nationalityPool:['Ecuador','Ecuador','Ecuador','Ecuador','Ecuador','Ecuador','Argentina','Uruguay','Colombia'] },
    { id:920010, name:'Independiente del Valle', country:'Ecuador', city:'Sangolquí', reputation:70, primaryColor:'#152B49', crestPath:'img/escudos/Independiente-del-Valle.svg', nationalityPool:['Ecuador','Ecuador','Ecuador','Ecuador','Ecuador','Ecuador','Argentina','Colombia','Uruguay'] }
  ])
});
