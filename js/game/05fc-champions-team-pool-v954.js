...
const CHAMPIONS_TEAM_POOL_CONFIG = Object.freeze({
  ...
  rosterVersion:'V9.54',
  teams:Object.freeze([
    { id:930001, name:'Bayern Múnich', country:'Alemania', city:'Múnich', reputation:90, primaryColor:'#DC052D', crestPath:'img/escudos/Bayern-Munich.svg', nationalityPool:['Alemania','Alemania','Alemania','Alemania','Alemania','Alemania','Francia','Países Bajos','Portugal','Inglaterra'] },
    { id:930002, name:'Borussia Dortmund', country:'Alemania', city:'Dortmund', reputation:84, primaryColor:'#FDE100', crestPath:'img/escudos/Borussia-Dortmund.svg', nationalityPool:['Alemania','Alemania','Alemania','Alemania','Alemania','Alemania','Francia','Países Bajos','Inglaterra','Croacia'] },
    { id:930003, name:'Bayer Leverkusen', country:'Alemania', city:'Leverkusen', reputation:85, primaryColor:'#E32221', crestPath:'img/escudos/Bayer-Leverkusen.svg', nationalityPool:['Alemania','Alemania','Alemania','Alemania','Alemania','Alemania','Francia','Países Bajos','Brasil','Croacia'] },
    { id:930004, name:'RB Leipzig', country:'Alemania', city:'Leipzig', reputation:80, primaryColor:'#DD0741', crestPath:'img/escudos/RB-Leipzig.svg', nationalityPool:['Alemania','Alemania','Alemania','Alemania','Alemania','Alemania','Francia','Países Bajos','Croacia','Inglaterra'] },

    { id:930005, name:'Paris Saint-Germain', country:'Francia', city:'París', reputation:90, primaryColor:'#004170', crestPath:'img/escudos/Paris-Saint-Germain.svg', nationalityPool:['Francia','Francia','Francia','Francia','Francia','Francia','Brasil','Portugal','España','Senegal'] },
    { id:930006, name:'Olympique de Marsella', country:'Francia', city:'Marsella', reputation:78, primaryColor:'#2FAEE0', crestPath:'img/escudos/Olympique-de-Marsella.svg', nationalityPool:['Francia','Francia','Francia','Francia','Francia','Francia','Marruecos','Senegal','Portugal','Argentina'] },

    { id:930007, name:'Benfica', country:'Portugal', city:'Lisboa', reputation:82, primaryColor:'#E30613', crestPath:'img/escudos/Benfica.svg', nationalityPool:['Portugal','Portugal','Portugal','Portugal','Portugal','Portugal','Brasil','España','Argentina','Uruguay'] },
    { id:930008, name:'Porto', country:'Portugal', city:'Oporto', reputation:81, primaryColor:'#00428C', crestPath:'img/escudos/Porto.svg', nationalityPool:['Portugal','Portugal','Portugal','Portugal','Portugal','Portugal','Brasil','España','Argentina','Colombia'] },

    { id:930009, name:'Zenit San Petersburgo', country:'Rusia', city:'San Petersburgo', reputation:76, primaryColor:'#009FE3', crestPath:'img/escudos/Zenit-San-Petersburgo.svg', nationalityPool:['Rusia','Rusia','Rusia','Rusia','Rusia','Rusia','Serbia','Croacia','Brasil','Colombia'] },
    { id:930010, name:'CSKA Moscú', country:'Rusia', city:'Moscú', reputation:70, primaryColor:'#D71920', crestPath:'img/escudos/CSKA-Moscu.svg', nationalityPool:['Rusia','Rusia','Rusia','Rusia','Rusia','Rusia','Serbia','Croacia','Bulgaria','Brasil'] },

    { id:930011, name:'PSV Eindhoven', country:'Países Bajos', city:'Eindhoven', reputation:82, primaryColor:'#E30613', crestPath:'img/escudos/PSV-Eindhoven.svg', nationalityPool:['Países Bajos','Países Bajos','Países Bajos','Países Bajos','Países Bajos','Países Bajos','Bélgica','Alemania','Brasil','Inglaterra'] },
    { id:930012, name:'Ajax', country:'Países Bajos', city:'Ámsterdam', reputation:79, primaryColor:'#D2122E', crestPath:'img/escudos/Ajax.svg', nationalityPool:['Países Bajos','Países Bajos','Países Bajos','Países Bajos','Países Bajos','Países Bajos','Bélgica','Dinamarca','Alemania','Ghana'] },

    { id:930013, name:'Olympiacos', country:'Grecia', city:'El Pireo', reputation:71, primaryColor:'#E30613', crestPath:'img/escudos/Olympiacos.svg', nationalityPool:['Grecia','Grecia','Grecia','Grecia','Grecia','Grecia','Serbia','Croacia','Portugal','Argentina'] },
    { id:930014, name:'Panathinaikos', country:'Grecia', city:'Atenas', reputation:68, primaryColor:'#117B45', crestPath:'img/escudos/Panathinaikos.svg', nationalityPool:['Grecia','Grecia','Grecia','Grecia','Grecia','Grecia','Serbia','Croacia','Bulgaria','Portugal'] },

    { id:930015, name:'Club Brujas', country:'Bélgica', city:'Brujas', reputation:74, primaryColor:'#0055A4', crestPath:'img/escudos/Club-Brujas.svg', nationalityPool:['Bélgica','Bélgica','Bélgica','Bélgica','Bélgica','Bélgica','Países Bajos','Francia','Ghana','Nigeria'] },
    { id:930016, name:'Anderlecht', country:'Bélgica', city:'Bruselas', reputation:69, primaryColor:'#5B2A86', crestPath:'img/escudos/Anderlecht.svg', nationalityPool:['Bélgica','Bélgica','Bélgica','Bélgica','Bélgica','Bélgica','Francia','Países Bajos','Ghana','Senegal'] },

    { id:930017, name:'Celtic', country:'Escocia', city:'Glasgow', reputation:75, primaryColor:'#008749', crestPath:'img/escudos/Celtic.svg', nationalityPool:['Escocia','Escocia','Escocia','Escocia','Escocia','Escocia','Inglaterra','Irlanda','Países Bajos','Japón'] },
    { id:930018, name:'Rangers', country:'Escocia', city:'Glasgow', reputation:73, primaryColor:'#005EB8', crestPath:'img/escudos/Rangers.svg', nationalityPool:['Escocia','Escocia','Escocia','Escocia','Escocia','Escocia','Inglaterra','Irlanda','Países Bajos','Nigeria'] },

    { id:930019, name:'FC Copenhague', country:'Dinamarca', city:'Copenhague', reputation:69, primaryColor:'#FFFFFF', crestPath:'img/escudos/FC-Copenhague.svg', nationalityPool:['Dinamarca','Dinamarca','Dinamarca','Dinamarca','Dinamarca','Dinamarca','Países Bajos','Alemania','Escocia','Ghana'] },
    { id:930020, name:'Sparta Praga', country:'República Checa', city:'Praga', reputation:69, primaryColor:'#7A1E2C', crestPath:'img/escudos/Sparta-Praga.svg', nationalityPool:['República Checa','República Checa','República Checa','República Checa','República Checa','República Checa','Croacia','Serbia','Alemania','Hungría'] }
  ])
});
