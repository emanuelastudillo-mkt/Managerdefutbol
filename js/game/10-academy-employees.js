...
const ACADEMY_FIRST_NAMES = ['Bruno', 'Mateo', 'Thiago', 'Lautaro', 'Benjamín', 'Julián', 'Santino', 'Tomás', 'Bautista', 'Franco', 'Facundo', 'Gael', 'Ignacio', 'Valentín', 'Ramiro', 'Nicolás', 'Agustín', 'Ezequiel', 'Simón', 'Máximo', 'Dante', 'Nahuel', 'Tobías', 'Matías', 'Enzo', 'Lorenzo', 'Jeremías', 'Joaquín', 'Manuel', 'Ciro', 'Elías', 'Renzo', 'Lisandro', 'Ulises', 'Milton', 'Kevin', 'Joel', 'Alan', 'Lucas', 'Pablo', 'Martín', 'Leandro', 'Gonzalo', 'Emiliano', 'Sebastián', 'Federico', 'Gabriel', 'Alexis', 'Rodrigo', 'Esteban', 'Cristian', 'Leonel', 'Adrián', 'Sergio', 'Rafael', 'Ariel', 'Mauro', 'Damián', 'Hernán', 'Fabián'];
const ACADEMY_LAST_NAMES = ['Luna', 'Rojas', 'Pereyra', 'Acosta', 'Sosa', 'Coronel', 'Vera', 'Molina', 'Cabrera', 'Medina', 'Campos', 'Suárez', 'Giménez', 'Arias', 'Silva', 'Farias', 'Roldán', 'Castro', 'Ferreyra', 'Benítez', 'Gómez', 'Rodríguez', 'Fernández', 'López', 'Martínez', 'Pérez', 'García', 'Sánchez', 'Romero', 'Torres', 'Díaz', 'Álvarez', 'Ruiz', 'Ramírez', 'Aguirre', 'Morales', 'Herrera', 'Navarro', 'Flores', 'Méndez', 'Ortega', 'Vargas', 'Cáceres', 'Miranda', 'Godoy', 'Ponce', 'Quiroga', 'Villalba', 'Carrizo', 'Espinoza', 'Peralta', 'Mansilla', 'Leiva', 'Bravo', 'Ojeda', 'Barrios', 'Vega', 'Maldonado', 'Domínguez', 'Palacios'];
const ACADEMY_COUNTRY_NAME_POOLS = {
  Argentina:{ first:ACADEMY_FIRST_NAMES, last:ACADEMY_LAST_NAMES },
  Chile:{ first:['Benjamín','Vicente','Matías','Joaquín','Tomás','Diego','Martín','Agustín','Cristóbal','Nicolás','Santiago','Facundo','Bastián','Maximiliano','Ignacio','Lucas','Gabriel','Sebastián','Franco','Valentín','Bruno','Mateo','Julián','Renato','Emiliano','Damián','Pablo','Felipe','Esteban','Rodrigo'], last:['González','Muñoz','Rojas','Díaz','Pérez','Soto','Contreras','Silva','Martínez','Sepúlveda','Morales','Rodríguez','López','Fuentes','Hernández','Torres','Araya','Flores','Espinoza','Valenzuela','Castillo','Reyes','Gutiérrez','Castro','Vargas','Ramírez','Álvarez','Carrasco','Vera','Tapia'] },
  Brasil:{ first:['João','Lucas','Gabriel','Matheus','Pedro','Rafael','Felipe','Gustavo','Bruno','Caio','Vitor','Henrique','Thiago','Diego','André','Eduardo','Leonardo','Marcos','Samuel','Davi','Luiz','Rodrigo','Igor','Renato','Vinicius','Alexandre','Daniel','Ruan','Pablo','Rômulo'], last:['Silva','Santos','Oliveira','Souza','Pereira','Costa','Rodrigues','Almeida','Nascimento','Lima','Ferreira','Gomes','Ribeiro','Carvalho','Martins','Rocha','Barbosa','Dias','Correia','Araujo','Melo','Cardoso','Teixeira','Cavalcanti','Monteiro','Vieira','Moreira','Freitas','Campos','Nunes'] },
  Inglaterra:{ first:['Oliver','Harry','George','Jack','Leo','Charlie','Thomas','William','James','Oscar','Jacob','Henry','Alfie','Freddie','Archie','Theo','Arthur','Edward','Joseph','Samuel','Daniel','Mason','Lewis','Ryan','Ethan','Adam','Finley','Harvey','Max','Noah'], last:['Smith','Jones','Taylor','Brown','Williams','Wilson','Johnson','Davies','Evans','Thomas','Roberts','Walker','Wright','Thompson','White','Hughes','Edwards','Green','Hall','Wood','Harris','Martin','Jackson','Clarke','Baker','Turner','Cooper','Hill','Ward','Moore'] },
  España:{ first:['Alejandro','Pablo','Hugo','Álvaro','Adrián','Diego','Javier','Mario','Sergio','Marcos','Daniel','David','Iván','Nicolás','Mateo','Lucas','Miguel','Ángel','Raúl','Rubén','Enrique','Iker','Asier','Gonzalo','Víctor','Óscar','Bruno','Jorge','Carlos','Manuel'], last:['García','Martínez','López','Sánchez','Pérez','Gómez','Martín','Jiménez','Ruiz','Hernández','Díaz','Moreno','Muñoz','Álvarez','Romero','Alonso','Gutiérrez','Navarro','Torres','Domínguez','Vázquez','Ramos','Gil','Serrano','Molina','Blanco','Castro','Ortiz','Rubio','Marín'] },
  Italia:{ first:['Lorenzo','Matteo','Alessandro','Francesco','Leonardo','Andrea','Riccardo','Gabriele','Marco','Davide','Giovanni','Simone','Federico','Nicola','Antonio','Edoardo','Tommaso','Filippo','Luca','Mattia','Pietro','Daniele','Cristian','Manuel','Stefano','Michele','Giacomo','Alberto','Dario','Vincenzo'], last:['Rossi','Russo','Ferrari','Esposito','Bianchi','Romano','Colombo','Ricci','Marino','Greco','Bruno','Gallo','Conti','De Luca','Mancini','Costa','Giordano','Rizzo','Lombardi','Moretti','Barbieri','Fontana','Santoro','Mariani','Rinaldi','Caruso','Ferrara','Galli','Martini','Leone'] },
  Rumania:{ first:['Andrei','Alexandru','Mihai','Stefan','Ionut','Cristian','Gabriel','Florin','Daniel','Radu','Vlad','George','Cosmin','Adrian','Nicolae','Darius','Marius','Sorin','Tudor','Razvan','Bogdan','Lucian','Ciprian','Claudiu','Valentin','Marian','Octavian','Victor','Emil','Cătălin'], last:['Popescu','Ionescu','Dumitru','Stan','Stoica','Gheorghe','Radu','Matei','Marin','Toma','Dobre','Munteanu','Moldovan','Dumitrescu','Preda','Ilie','Florea','Nistor','Dragomir','Neagu','Lazar','Barbu','Voicu','Manea','Enache','Serban','Tudor','Cristea','Ciobanu','Vasile'] }
};
