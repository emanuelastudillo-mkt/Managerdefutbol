...
const MANAGER_COURSE_LICENSES = {
  basic:{
    ...
    topics:[
      ...
      { id:'fitness', title:'Estado físico y calendario', text:'La forma física baja con partidos y entrenamientos. Liga, copas nacionales y Mundial de Clubes pueden generar semanas exigentes, por lo que la rotación debe planificarse con anticipación.', example:'Reservá a un titular cansado antes de una semifinal o final, no después de que se lesione.' },
  ...
  international:{
    ...
    topics:[
      ...
      { id:'world-cup', title:'Copas nacionales y Mundial de Clubes', text:'Las copas nacionales usan eliminación directa, estadios neutrales y finales en octubre. Las supercopas se juegan el día 300. El Mundial de Clubes combina fase de grupos y llaves posteriores.', example:'Separá las cargas de octubre y del cierre anual para no llegar al Mundial con el plantel agotado.' },
