/* V8.08 · Licencias progresivas actualizadas para contratos y Academia personal. */
...
const MANAGER_COURSE_LICENSES = {
  basic:{
    ...
    topics:[
      ...
      { id:'morale', title:'Moral y cohesión', text:'El estado anímico y el funcionamiento colectivo condicionan la estabilidad interna. Si cualquiera de los dos entra en una zona crítica se controla una posible crisis cada 5 días. Cada control tiene 30% de probabilidad y, si pasan 20 días sin incidentes, el siguiente genera uno. Los conflictos requieren respuesta y pueden dejar promesas pendientes.', example:'Mantené una base reconocible, respondé los conflictos y cumplí las promesas de minutos para recuperar confianza.' },
